    ...
    const fetchData = async () => {
      try {
        ...
        const tasksWithLatestStatus = divisionTasks.map(task => {
          ...
          return {
            ...task,
            latestStatus: taskStatuses[0]?.statut || 'pending'
          };
        });
    ...
    <div className="statsGrid">
        ...
        <div className="statCard">
          ...
          <h2 className="statValueYellow">
            {statuses.find(s => s.statut === 'in_progress')?.count || 0}
          </h2>
        </div>
        ...
        <div className="statCard">
          ...
          <h2 className="statValueGreen">
            {statuses.find(s => s.statut === 'completed')?.count || 0}
          </h2>
        </div>
      ...
      <button onClick={()=>{alert(iddiv)}}>bonjour</button>
